# -*- coding: utf-8 -*-
"""
Created on Sat Jul 11 22:45:11 2020
...
path='./FP4p/'
#模型保存地址
model_path='./model/model_OOO.ckpt'
#基础学习率
...
def inference(input_tensor, train, regularizer):
    with tf.variable_scope('layer1-conv1'):
        conv1_weights = tf.get_variable("weight",[10,10,3,32],initializer=tf.truncated_normal_initializer(stddev=0.1))
    ...
    with tf.variable_scope("layer3-conv2"):
        conv2_weights = tf.get_variable("weight",[10,10,32,64],initializer=tf.truncated_normal_initializer(stddev=0.1))
